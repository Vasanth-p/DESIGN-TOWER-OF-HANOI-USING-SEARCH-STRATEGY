        ...
        for source in range(3):
            for destination in range(3):
                if source != destination and state.pegs[source]:
                    ...
                    new_state = State(new_pegs, state.steps + f"Move disc {disc} from {chr(65+source)} to {chr(65+destination)}\n")
